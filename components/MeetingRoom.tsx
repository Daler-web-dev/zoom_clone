    ...
    return (
        <section className='w-full h-screen text-white relative pt-4 overflow-hidden'>
            <div className='relative size-full flex items-center justify-center'>
                ...
                <div className={cn("absolute top-0 right-5 h-[calc(100vh-86px)] hidden ml-2 bg-white rounded-2xl text-black p-5", { "show-block": showParticipants })}>
            ...
            <div className='fixed bottom-0 flex w-full items-start justify-end gap-5 mb-4'>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className='border-[#19232d] bg-[#19232d] text-white '>
